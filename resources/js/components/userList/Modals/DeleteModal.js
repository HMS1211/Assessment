...
class DeleteModal extends Component {
    ...
    // Delete function for product data.
    

    deleteProductData = (product) => {
        axios.delete('/delete/products/list/' + product).then(() => {
            ...
            <div className="modal fade" id={"deleteModal"+this.props.modalId } tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="exampleModalLabel">product Delete</h5>
                    ...
                    <div className="modal-body">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button"
                                ...
                                onClick={ () => {this.deleteProductData(this.props.modalId)}}>
                                Yes
                            </button>
                            <button type="button"
